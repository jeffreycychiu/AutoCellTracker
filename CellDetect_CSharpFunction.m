...
function [cSharpA, cSharpB] = CellDetect_CSharpFunction(imageFolderPath, 
    ROUND_LIMIT, CELL_FUDGE_UPPER_BOUND, CELL_FUDGE_LOWER_BOUND, CELL_AREA_MINIMUM)
...
filename = 'trackedCells.csv'; %get this from C# as well
